...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT downloads.NoteTitle,downloads.NoteCategory,referencedata.Value,downloads.PurchasedPrice,
            ...
            WHERE downloads.NoteTitle LIKE '%$search_result%' OR downloads.NoteCategory LIKE '%$search_result%' LIMIT $start_from,$limit" ;

    $result = mysqli_query($conn, $query);
  

    $result_num = mysqli_query($conn, "SELECT COUNT(downloads.ID) FROM downloads LEFT JOIN referencedata 
    ON downloads.IsPaid=referencedata.ID WHERE downloads.NoteTitle LIKE '%$search_result%' OR downloads.NoteCategory LIKE '%$search_result%'");
                                ...
                                echo " 
                                    <tr>
                                        ...
                                        <div class='dropdown dropdown-dots-table'>
                                            ...
                                            <div class='dropdown-menu' aria-labelledby='dropdownMenuLink'>
                                                <a class='dropdown-item' href='allowdownload.php'>Allow Download</a>
                                            </div>
                                        </div>
                                    </td>
                                    </tr>";
