...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT notes.ID,notes.CreatedDate,notes.Note_Title, category.Category_name,referencedata.Value FROM notes LEFT JOIN  category ON notes.Category=category.ID LEFT JOIN referencedata ON notes.Status=referencedata.ID WHERE notes.Note_Title LIKE '%$search_result%' OR category.Category_Name LIKE '%$search_result%' OR referencedata.Value LIKE '%$search_result%' AND notes.IsActive=1 AND referencedata.ID IN (6,7,8) ORDER BY notes.CreatedDate DESC LIMIT $start, $limit";
	...
	$result_num = mysqli_query($conn, "SELECT COUNT(ID) FROM notes WHERE notes.Note_Title LIKE '%$search_result%' OR notes.IsActive=1 AND Status IN (6,7,8)");
                        ...
                        <div class="row no-gutters dashboard-left">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                <div class="numbers-of-notes dashboard-box">
                                    <p class="dashboard-single-details text-center">100</p>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                <div class="money-earned dashboard-box">
                                    <p class="dashboard-single-details text-center">$10,00,000</p>
                        ...
                        <div class="row no-gutters ">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                <div class="my-download dashboard-box">
                                    <p class="dashboard-single-details text-center">38</p>
                                    <p class="dashboard-detail-heading text-center">My Downloads</p>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                <div class="rejected-notes dashboard-box">
                                    <p class="dashboard-single-details text-center">12</p>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                                <div class="buyer-request dashboard-box">
                                    <p class="dashboard-single-details text-center">102</p>
...
if (isset($_POST['published-search'])) {
    ...
    $query = "SELECT notes.PublishedDate,notes.Note_Title, category.Category_name,referencedata.Value,notes.Price FROM notes LEFT JOIN  category ON notes.Category=category.ID LEFT JOIN referencedata ON notes.Is_Paid=referencedata.ID WHERE( notes.Note_Title LIKE '%$search_publish%' OR category.Category_Name LIKE '%$search_publish%' OR referencedata.Value LIKE '%$search_publish%' )AND notes.IsActive=1 AND notes.Status=9 ORDER BY notes.PublishedDate DESC LIMIT $start2, $limit";
	$result2 = mysqli_query($conn, $query);
    
	$result_num2 = mysqli_query($conn, "SELECT COUNT(ID) FROM notes WHERE Note_Title LIKE '%$search_publish%'  AND notes.IsActive=1 AND notes.Status=9");
                            ...
                            <?php
                                while ($row = mysqli_fetch_assoc($result2)) {
                                    ...
                                    echo "<tr>
                                            ...
                                            <td>$refe_data2</td> 
                                            <td>$sell_price</td>
                                            <td> <a href='note-details.php'><img src='images/login/eye.png' title='Click to View' alt='View'></a> </td>
                                         </tr>";
                                }
                                ?>
                            </tbody>
