...
if ($exist != 0) {
    ...
    while ($row = mysqli_fetch_assoc($query)) {
        ...
        $current_phone_country_code = $row['Phone_No_Country_Code'];
    }
    /*if($query){
        echo "selected";
    }else{
...
if (isset($_POST['submit'])) {
    ...
    $destinationfile = "../Members/default/profile_pic_default.png";
   ...
   $update_query = "UPDATE users_details SET Dob='$dob',Gender='$gender',Phone_No_Country_Code='$phone_code',
