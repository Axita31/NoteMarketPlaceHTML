            ...
            <form>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="countryname" class="form-control input-light-color"
                        ...
                        <div class="col-md-12">
                            <div class="form-row">
                                <div class="form-group col-md-6 desc-detail">
                                    ...
                                    <input type="text" name="countrycode" class="form-control input-box input-light-color"
                        ...
                        <div class="col-md-12">
                            <div class="form-row">
                                <button type="submit" name="submit" id="my-profile-submit-btn" class="btn btn-primary country-btn">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
