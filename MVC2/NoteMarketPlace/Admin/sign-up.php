...
if(isset($_POST['signup'])){
    ...
    if(strlen($fname) < 3 && strlen($lname)){
        ...
        if($emailcount == 0 && $password_match && $upper_pwd_check && $lower_pwd_check && $number_pwd_check && $length_check){
                    ...
                    <div id="sign-up-box">
                        ...
                        <form action="sign-up.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control input-box-style" id="exampleInputPassword1" placeholder="Enter your password" autocomplete="on" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="cpassword" class="form-control input-box-style" id="exampleInputPassword1" placeholder="Enter your confirm password" autocomplete="on" required> 
                                <div class="eye"><img class="eye-img" src="images/login/eye.png" alt="eye"></div>
