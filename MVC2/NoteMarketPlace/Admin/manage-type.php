            ...
            <div class="container">
                ...
                <div class="row">   
                    <div class="col-lg-5 col-md-5 col-sm-5 col-12 text-left box-heading-wrapper">
                        <button onclick="window.location.href='add-type.html'" class="btn btn-general btn-purple add-type-btn">Add Type</button>
                    </div>
