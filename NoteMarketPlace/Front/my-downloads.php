...
if (isset($_POST['search'])) {
    ...
    //main query
    $query_data_getter = "SELECT DISTINCT downloads.NoteID,downloads.DownloaderID,downloads.NoteTitle,downloads.
    ...
    $result = mysqli_query($conn,$query_data_getter);
                ...
                <div class="my-downloads-table general-table-responsive">
                    <div class="table-responsive-xl">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            <?php                              
                            $downlaods_data_getter = mysqli_query($conn, $query_data_getter);
                            $sr_no = 1;
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a class="purple-td" title="click to view <?php echo $notetitle ?>" href="notes-details.php?id=<?php echo $noteid ?>"><?php echo $notetitle ?></a>
                                    </td>
    ...
    <?php
        ...
        //mark as an inappropriate pop up
            if (isset($_POST['inappropriate_submit'])) {
                ...
                $seller_id_getter = mysqli_query($conn, "SELECT ID FROM Downloads WHERE NoteID=$noteid_inappropriate");
                
                while ($row = mysqli_fetch_assoc($seller_id_getter))
                 $sellerid_inappropriate = $row['ID'];
                // echo $sellerid_inappropriate;
