...
//data fetcing  for session  

if(isset($_SESSION['email'])){
    $email = $_SESSION['email'];

    //buyer getter
    $buyer_getter = mysqli_query($conn, "SELECT ID,FirstName,LastName FROM users WHERE EmailID = '$email' ");
    
    while ($row = mysqli_fetch_assoc($buyer_getter)){     
        $buyerid = $row ['ID'];
        $buyer_fullname = $row ['FirstName'] ." ".$row['LastName'];

        //seller getter
        $seller_getter = mysqli_query($conn,"SELECT SellerID,Price,Note_Title,Category,Is_Paid FROM notes WHERE ID=$noteid");
        ...
        //category getter
        $category_getter = mysqli_query($conn ,"SELECT Category_name FROM category WHERE ID=$category_id");
        while ($row = mysqli_fetch_assoc($category_getter)){
        $categoryname = $row['Category_name'];
        }

         $download_entry_checker = mysqli_query($conn, "SELECT ID FROM downloads WHERE NoteID=$noteid AND DownloaderID=$buyerid");
...
$contact_us_phone_no = "91 7048600717";
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p>In case, you have urgency,<br>Please contact us on <?php echo '+' . $contact_us_phone_no ?>.</p>
                ...
                <div class="row no-gutters">
                    <div class="col-lg-5 col-md-5 col-sm-12 col-12">
                        <div class="note-preview-box">
                            ...
                            <?php $notes_preview_getter = mysqli_query($conn, "SELECT NotesPreview FROM notes WHERE ID=$noteid");
