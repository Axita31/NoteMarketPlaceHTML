                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div id="upload-note" class="user-profile-photo-uploader right-content">
                                    <label for="image-uploader"><img src="images/add-note/upload-note.png" class="right-content note-img-upload" title="Click here to upload your notes" alt="Upload your notes here"></label>
                                    <input id="image-uploader" name="upload_notes[]" <?php if (isset($_GET['id'])) echo "";else echo "required"; ?>class="form-control right-content" type="file" multiple>         
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="note-preview">
                                    <div class="user-profile-photo-uploader right-content">
                                        ...
                                        <input id="image_uploader" name="note_preview" class="form-control" type="file" required>
                                        <div class="incorrect-password-label">
                                            <?php
