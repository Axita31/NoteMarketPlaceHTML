                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="note-box-details">
                                    ...
                                    if(isset($_SESSION['email'])){
                                        ...
                                        //if note is paid
                                        if ($sell_type == 4) {
                                            echo " <button style='width:200px;' class='btn btn-general btn-purple' href='#' role='button' data-toggle='modal'
                                        ...
                                        if ($sell_type == 5) {
                                            ...
                                            if ($attact_count <= 1) {
                                                ...
                                                echo " <button style='width:180px;' type='submit' name='single_download' class='btn btn-general btn-purple'>download</button>";
                                                echo "</form>";
                                        ...
                                        ?>
                                            <form action="" method="post">
                                                <button style='width:180px;' name='download_all' class='btn btn-general btn-purple'>download</button>
                                            </form>
                                            <?php
                                                    }
                                                }
                                    ...
                                    //if user has not log-in
                                        ...
                                        echo " <button style='width:180px;' class='btn btn-general btn-purple' name='no-login'>download</button>";
                                        echo "</form>";
                                    } 
                                ?>
                        ...
                        <div class="row no-gutters">
                            ...
                            <div>
                                ...
                                if ($inappropriate_count > 0) { ?>
                                    <p style="color:red; margin-left:100px;" class="note-red-text"><?php echo $inappropriate_count ?> User(s) marked this note as inappropriate</p>
                                <?php }  ?>                      
                           </div>
                    </div>
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 col-12">
                        <div class="customer-review-box">
                            ...
                            if (mysqli_num_rows($review_decide) > 0) {
                                ...
                                $rate_counter = 1;
                                $review_getter = mysqli_query($conn, "SELECT r.ID,r.ReviewedByID,r.Comments,r.ratings,u.FirstName,u.Lastname,up.Profile_Pic FROM 
                                sellernotesreviews r LEFT JOIN users u ON r.ReviewedByID=u.ID LEFT JOIN users_details up ON up.UserID=u.ID  WHERE r.NoteID=$noteid 
                                AND r.IsActive=1");
                                ...
                                <div class="customer-review-detail">
                                        ...
                                        <?php if ($review_count > 0) { ?>
                                            <div class="col-lg-2 col-md-3 col-sm-2 col-12">
                                                ...
                                                <img src="../Members/default/DP_default.jpg"  class="reviewer-img" alt="Customer Photo ">
                                                <?php } ?>
                                                <?php if ($member_pic != "") { ?>
                                                <img src="<?php echo $member_pic ?>" class="reviewer-img" alt="Customer Photo">
                                                <?php } ?>                                        
                                            </div>
                                            <div class="col-lg-10 col-md-9 col-sm-10 col-12">
                                                ...
                                                <div style="position: absolute;right: 40px;">
                                                    <a href="delete_review.php?id=<?php echo $review_row ?>&noteid=<?php echo $noteid ?>"
                                                        title="Delete">
