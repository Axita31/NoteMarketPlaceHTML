...
$update_type = mysqli_query($conn ," UPDATE type SET Type_Name='$type',Description='$desc',ModifiedBy=$userid,
                    ModifiedDate=now() WHERE ID=$type_id");
...
if(isset($_POST['submit'])){
    ...
    $insert_type= "INSERT INTO type (Type_Name, Description, CreatedBy, CreatedDate, IsActive) VALUES ('$type' ,'$desc',$userid ,now(),1)";
    $result = mysqli_query($conn , $insert_type) ;
    if(!$result){
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <?php //Get type
                                    if(isset($_GET['id'])){
                                        $type_id = $_GET['id'];
                                    $select_type = mysqli_query($conn, "SELECT Type_Name,Description FROM type WHERE ID=$type_id");
                                ...
                                ?>
                                <input type="text" name="type" value= "<?php echo (isset($_GET['id']))?$type_name:'';?>" class="form-control input-light-color"
