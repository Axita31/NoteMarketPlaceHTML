...
if(isset($_POST['deactive-yes'])){
      ...
      $deactive_query=mysqli_query($conn,"UPDATE type SET IsActive=0 WHERE ID=$get_type_id");
                        ...
                        <li>
                            <div class="dropdown settings-btn-dropdown">
                                ...
                                <?php } ?>
                                    ...
                                    <a class="dropdown-item active" href="manage-type.php">Manage Type</a>
            ...
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-12 text-left">
                        <p class="dashboard-heading">Manage type</p>
                    </div>
                </div>
                <div class="row">   
                        ...
                        <form action="manage-type.php" method="POST">
                            <div class="row no-gutters text-right general-search-bar-btn-wrapper">
                                <div class="form-group has-search">
                                    ...
                                    <input type="text" name="search_type" class="form-control search-bar" placeholder="Search">
                                </div> 
                         ...
                         <thead>
                            ...
                            <?php
                                if(isset($_POST['search'])){
                                    ...
                                    $type_data ="SELECT type.ID,type.Type_Name,type.Description,type.CreatedDate,type.IsActive,
                                    users.FirstName,users.LastName FROM type LEFT JOIN users ON type.CreatedBy = users.ID WHERE 
                                    (type.Type_Name LIKE '%$search_type%' OR type.Description LIKE '%$search_type%' OR users.FirstName LIKE '%$search_type%' OR users.LastName LIKE '%$search_type%' OR type.CreatedDate LIKE '%$search_type%') ORDER BY type.CreatedDate desc";

                                    $type_result = mysqli_query($conn , $type_data);
    
                                }else{
                                    $type_data ="SELECT type.ID,type.Type_Name,type.Description,type.CreatedDate,type.IsActive,
                                    users.FirstName,users.LastName FROM type LEFT JOIN users ON type.CreatedBy = users.ID ORDER BY type.CreatedDate desc";
                                   $type_result = mysqli_query($conn , $type_data);
                                }
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href = "add-type.php?id=<?php echo $id ; ?>">
                ...
                <div class="modal-content">
                    ...
                    <form action="manage-type.php" method="POST">
                        <div style="margin-top: 20px;" class="modal-body">
                            <p class="title">Are you sure you want to make this type inactive ? </p>
