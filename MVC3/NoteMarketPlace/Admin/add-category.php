...
$update_category = mysqli_query($conn ," UPDATE category SET Category_name='$category',Description='$desc',ModifiedBy=$userid,
                    ModifiedDate=now() WHERE ID=$cat_id");
...
if(isset($_POST['submit'])){
    ...
    $insert_category= "INSERT INTO category (Category_name, Description, CreatedBy, CreatedDate, IsActive) VALUES ('$category' ,'$desc',$userid ,now(),1)";
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <?php //Get category
                                    if(isset($_GET['id'])){
                                        $cat_id = $_GET['id'];
                                    $select_cat = mysqli_query($conn, "SELECT Category_name,Description FROM category WHERE ID=$cat_id");
                                ...
                                ?>
                                <input type="text" name="category" value= "<?php echo (isset($_GET['id']))?$category_name:'';?>" class="form-control input-light-color"
                    ...
                    <div class="col-md-12">
                        <div class="form-row">
                            <div class="form-group col-md-6 desc-detail">
                                ...
                                <input type="text" name="description" value= "<?php echo (isset($_GET['id']))?$description:'';?>" class="form-control input-box input-light-color"
