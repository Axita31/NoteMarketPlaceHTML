...
if(isset($_POST['deactive-yes']))
{
      ...
      $deactive_query=mysqli_query($conn,"UPDATE category SET IsActive=0 WHERE ID=$get_cat_id");
...
<!-- Header ends -->
    ...
    <!-- Manage category  part-->
    <div id="manage-category">
        <div class="content-box-lg">
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-12 text-left">
                        <p class="dashboard-heading">Manage Category</p>
                    </div>
                </div>
                <div class="row">   
                    <div class="col-lg-5 col-md-5 col-sm-5 col-12 text-left box-heading-wrapper">
                        <button onclick="window.location.href='add-category.php'" class="btn btn-general btn-purple add-type-btn">Add Category</button>
                    </div>
                        ...
                        <form action="manage-category.php" method="POST">
                            <div class="row no-gutters text-right general-search-bar-btn-wrapper">
                                <div class="form-group has-search">
                                    ...
                                    <input type="text" name="search_category" class="form-control search-bar" placeholder="Search">
                                </div> 
                        ...
                        <table class="table table-bordered" id="myTable">
                            ...
                            <?php
                                if(isset($_POST['search'])){
                                    ...
                                    $category_data = "SELECT category.ID,category.Category_name,category.Description,category.CreatedDate,category.IsActive,
                                    users.FirstName,users.LastName FROM category LEFT JOIN users ON category.CreatedBy = users.ID WHERE (category.Category_name LIKE '%$search_category%'  OR category.Description LIKE '%$search_category%' OR 
                                    users.FirstName LIKE '%$search_category%' OR users.FirstName LIKE '%$search_category%' OR  category.CreatedDate LIKE '%$search_category%') ORDER BY category.CreatedDate desc ";
  
                                    $category_result = mysqli_query($conn , $category_data);

    
                                }else{
                                    $category_data ="SELECT category.ID,category.Category_name,category.Description,category.CreatedDate,category.IsActive,
                                    users.FirstName,users.LastName FROM category LEFT JOIN users ON category.CreatedBy = users.ID ORDER BY category.CreatedDate desc";
                                   $category_result = mysqli_query($conn , $category_data);
                                }
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href ="add-category.php?id=<?php echo $id ?>">
